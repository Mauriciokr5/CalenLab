<?php 
  ...
  if (isset($_SESSION['Id_Usuario'])) {
    ...
    if (count($Datos)>0 && ($TiposUsuario>=3) ) {
      $User = $Datos;
...
<body>
  ...
  <?php require 'partials/headerSolicitante.php' ?>
			...
			$('#CalendarioWeb').fullCalendar({
				...
				customButtons:{
					customButton:{
						...
						click: function(){
							window.location.href='ReservarSolicitante.php'
					}
				}
			},
			<?php  
	...
	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
		...
		$('#Modificar').click(function(){
			...
			window.location="Mod_ReservaSolicitante.php?Id_Reserva="+Id_Reserva;
